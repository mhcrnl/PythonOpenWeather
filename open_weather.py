#!/usr/bin/python
'''
    Python program to find current weather details of
any city using openweathermap api.
'''
# import required modules
import requests, json
# Enter your API key here
api_key = "bf7be29e1775efb51f2311a0c952d151"
# base_url variable to store url
base_url = "http://api.openweathermap.org/data/2.5/weather?"
# Give city name
city_name = input("Introduceti numele orasului: ")
...
if x["cod"] != "404":
    ...
    # print followig values
    print(" Temperatura in Kelvin este = " +
